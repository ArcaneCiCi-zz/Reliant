...
if %relversion%==1.3 goto welcome
if NOT %relversion%==1.3 goto client_updater
...
goto choice
:kill
set /p input=Enter the process name/PID you wish to terminate:
